...
FROM enquiry where is_verified='0' ORDER  BY enquiry_id DESC");
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="edit">                                                            
                                                            <a class="btn btn-sm btn-success edit-item-btn" href='enquiry-verify.php?id=<?php echo $enq['enquiry_id']; ?>' ;><i class=" ri-check-line"></i></a>
                                                        </div>
