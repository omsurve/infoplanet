                ...
                <div class="navbar-brand-box">
                    ...
                    <a href="index.php" class="logo logo-light">
                        ...
                        <span class="logo-lg p">
                            ...
                            <h3 class="text-white fw-bold mt-4 border border-3 px-4 py-1 border-white rounded-pill">ADMIN</h3>
                        </span>
                    </a>
                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="navbar-nav" id="navbar-nav">
                            ...
                            <li class="nav-item">
                              ...
                              <li class="nav-item">
                                            <a class="nav-link collapsed" data-bs-target="#forms-nav" href="enquiry.php">
                                                <i class="bi bi-person"></i>
                                                <span>Enquiry</span>
                                            </a>
                                        </li>
                                           <li class="nav-item">
                                            <a class="nav-link collapsed" data-bs-target="#forms-nav" href="course-add.php">
                                                <i class="bi bi-person"></i>
                                                <span>Course</span>
                                            </a>
                                        </li>
                                           <li class="nav-item">
                                            <a class="nav-link collapsed" data-bs-target="#forms-nav" href="batch-add.php">
                                                <i class="bi bi-person"></i>
                                                <span>Batch</span>
                                            </a>
                                        </li>
