                            ...
                            <div class="card-body">
                                <div class="live-preview">
                                    <div class="row gy-4">
                                        ...
                                        <input type="hidden" class="form-control" id="placeholderInput" name="id" value="<?php echo $user['id']; ?>">

                                        <!--end col-->
                                        <div class="col-xxl-3 col-md-4">
                                            <div>
                                                <label for="placeholderInput" class="form-label">Name<span class="text-danger fs-15 "> *</span></label>
                                                <input type="text" required class="form-control" id="placeholderInput" placeholder="Enter Your Name" name="name" value="<?php echo $user['name']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xxl-3 col-md-4">
                                            <div>
                                                ...
                                                <input type="number" required class="form-control" id="mobile_number" value="<?php echo $user['mobile']; ?>" name="mobile_number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xxl-3 col-md-4">
                                            <div>
                                                ...
                                                <textarea class="form-control" id="placeholderInput" placeholder="Enter Your details" name="other"><?php echo $user['other_details']; ?></textarea>
                                            </div>
                                        </div>
